            ...
            <form action="<?= base_url('UserPemetaan/Add') ?>" method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Tambahkan Kecamatan ">
                    </div>
                    <div class="form-group">
                        <label for="tahun">Tahun</label>
                        <input type="number" class="form-control" placeholder="Tambahkan Tahun">
                    </div>
                    <div class="form-group">
                        <label for="luas_lahan">Luas Lahan</label>
                        <input type="number" class="form-control" placeholder="Masukkan Luas Lahan">
                    </div>
                    <div class="form-group">
                        <label for="produksi">Produksi</label>
                        <input type="number" class="form-control" placeholder="Masukkan Jumlah Produksi">
                    </div>
                    <div class="form-group">
                        <label for="produktifitas">Produktifitas</label>
                        <input type="number" class="form-control" placeholder="Masukkan Jumlah Produktifitas">
                    </div>
                </div>
                <!-- /.box-body -->
