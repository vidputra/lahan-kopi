            ...
            <form role="form" action="<?= base_url('UserPemetaan/Edit/' . $data->id_pm) ?>" method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $data->kecamatan ?>" class="form-control" placeholder="Tambahkan Kecamatan ">
                    </div>
                    <div class="form-group">
                        <label for="tahun">Tahun</label>
                        <input type="number" value="<?= $data->tahun ?>" class="form-control" placeholder="Tambahkan Tahun">
                    </div>
                    <div class="form-group">
                        <label for="luas_lahan">Luas Lahan</label>
                        <input type="number" value="<?= $data->luas_lahan ?>" class="form-control" placeholder="Masukkan Luas Lahan">
                    </div>
                    <div class="form-group">
                        <label for="produksi">Produksi</label>
                        <input type="number" value="<?= $data->produksi ?>" class="form-control" placeholder="Masukkan Jumlah Produksi">
                    </div>
                    <div class="form-group">
                        <label for="produktifitas">Produktifitas</label>
                        <input type="number" value="<?= $data->produktifitas ?>" class="form-control" placeholder="Masukkan Jumlah Produktifitas">
                    </div>
                </div>
                <!-- /.box-body -->
